...
你可以在本站 [/数字生命一览](/docs/numBili/数字生命一览/105654431) 看到UP已确认的数字生命。

由于相关用户数量极为庞大且难以追踪（部分会定期更换用户名头像等），本站列出的部分用户仅为举例，具体能否判定为数字生命，可以参考以下判定标准。


:::tip 特别鸣谢

[aicu.cc](https://aicu.cc)的评论检索，帮助我们节省了很多时间来确认评论和用户真实性 

我们也推荐通过历史评论的内容来判定是否为数字生命
...
- 大会员在期（以观测时间为准） -0分
  ...
  -0分是指这些指标虽然一定程度上反应了这个账号的真实性，但有些已经实名认证的账号也被用于灰产刷评论进而规避检测，因此降低权重为0
